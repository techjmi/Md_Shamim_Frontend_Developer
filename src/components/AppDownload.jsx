...
const AppDownload = () => {
  return (
   ...
   <div className=" flex mx-auto flex-col items-center p-[32px] rounded-[16px] w-[800px] h-[370px] shadow-[0px_1px_25px_0px_#1DCEF240_inset]  bg-[var(--color-cyan-1270,#0C2B2FB2)]">
