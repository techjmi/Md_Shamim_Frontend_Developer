export default function RoadMap() {
    const items = ["Launch of EthAi: Officially", "Development of Core AI Agents", "User Onboarding Campaign",'Community Engagement Initiatives']; 
    const items2=[
  ...
  const url='https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.vecteezy.com%2Ffree-photos%2Fnature-background&psig=AOvVaw3eBn0abbCJXAQSFGa2wy1s&ust=1737266558871000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCPimx7PM_ooDFQAAAAAdAAAAABAJ'
    return (
      <div className="bg-[#00161D] text-white pt-16">
